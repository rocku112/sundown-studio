...
const PRECACHE = [
  ...
  'js/data/hexagram-data.js', 'js/data/tarot-data.js', 'js/data/qian-data.js', 'js/data/name-chars.js', 'js/data/name-premium.js', 'js/data/name-mainland.js', 'js/data/name-korean.js', 'js/data/name-singles.js', 'js/data/name-themes.js', 'js/data/name-freq.js', 'js/data/name-taiwan.js', 'js/data/kangxi-strokes.js', 'js/data/cities.js',
  'js/app.js',
